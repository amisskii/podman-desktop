...
export async function ensureKindCliInstalled(page: Page): Promise<void> {
  ...
  if (!(await resourcesPage.resourceCardIsVisible(RESOURCE_NAME)) && !skipKindInstallation) {
...
async function createKindCluster(page: Page, timeout: number = 120000): Promise<void> {
