...
| Image name input     | `[aria-label="Image to Pull"]`                               |
...
| Done (after pull)    | `[aria-label="Tab Content"] button:has-text("Done")`         |
...
| Image name input    | `[placeholder="my-custom-image"]`                                  |
...
5. Fill image name: `fill('[aria-label="Image to Pull"]', '{imageName}')`
6. Click Pull image: `click('button:has-text("Pull image")')`
7. Wait for completion: `wait('[aria-label="Tab Content"] button:has-text("Done")', { timeout: 60000 })`
8. Click Done: `click('[aria-label="Tab Content"] button:has-text("Done")')`
...
6. Fill image name: `fill('[placeholder="my-custom-image"]', '{imageName}')`
...
- After pulling, wait for `Done` or `View details` button before navigating away
