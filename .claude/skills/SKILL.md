...
- MCP server `electron-test` configured in `~/.claude.json`
- Podman Desktop repository at `$PODMAN_DESKTOP_DIR`
- Either:
...
- Create isolated test directory at `/tmp/pd-mcp-test-{timestamp}`
...
```bash
# DON'T run with & or in background mode
$SKILL_DIR/start-with-cdp.sh  # Run directly in terminal
```
...
All MCP testing resources are located in this skill directory: `/home/anton/.claude/skills/podman-desktop-mcp/`
...
- `/home/anton/.claude/skills/podman-desktop-mcp/TESTING-WITH-MCP.md`
- `/home/anton/.claude/skills/podman-desktop-mcp/mcp-test-examples.md`
- `/home/anton/.claude/skills/podman-desktop-mcp/start-with-cdp.sh`
- `/home/anton/.claude/skills/podman-desktop-mcp/SKILL.md` (this file)
